...
public class HumanitarianMission extends Mission {
    ...
    public HumanitarianMission() {
        System.out.println(" Includes military engagement or combat operations.");
        System.out.println("<<<<---------------------------->>><<<<------------------------------->>><<<------------>>>");
        System.out.println("You must ENTER ATLEAST 1 PERSON FOR THE MISSION");
        int minPeople = 1;
        int count = 1;
        boolean momo = true;
        while (momo) {
        ...
        boolean recon = true;
        while (recon) {
            System.out.println("HUMANITARIAN MISSION OPERATIONS");
            System.out.println("<<<<<<<<<<<<<                       >>>>>>");
    ...
    public void assignTask(Personnel personnel) {
        ...
        System.out.println("---------------");
        System.out.println("TASK 1: DISTRIBUTION");
        System.out.println("TASK 2: MEDICAL AID");
        System.out.println("TASK 3: LOGISTICS");
        System.out.println("Select the Task Number");
        int task = sc.nextInt();
        if (task == 1) {
            System.out.println("Task is available");
            personnel.setPersonnelTask("DISTRIBUTION");
        } else if (task == 2) {
            personnel.setPersonnelTask("MEDICAL AID");
        } else if (task == 3) {
    ...
    public void trackMissionProgress() {
        ...
        System.out.println("---------------");
        System.out.println("Status 1: POSITIVE IMPACT");
        System.out.println("Status 2: NEGATIVE IMPACT");
        System.out.println("Enter the status number of the Mission");
        int stat = sc.nextInt();
        switch (stat) {
            case 1:
                setStatus("POSITIVE IMPACT");
                break;
            case 2:
                setStatus("NEGATIVE IMPACT");
                break;
            default:
