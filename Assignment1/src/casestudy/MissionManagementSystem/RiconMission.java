...
public class RiconMission extends Mission{
    ...
    public  RiconMission(){
        System.out.println("The mission is focused on gathering intelligence");
        System.out.println("<<<<>>>------------------<<<<>>>>----------------------------<<<>>>");
        System.out.println("You must ENTER ATLEAST 2 PEOPLE FOR THE MISSION");
        int minPeople=2;
        int count= 1;
        boolean momo=true;
        while(momo){
            ...
            personnel.setPersonnelRole(role);
        ...
        while (recon){
            ...
            switch (choice3){
                case 1:
                    ...
                    sc.nextLine();
                    System.out.println("Do you want to perform other Ricon Mission Operations");
                ...
                case 2:
                    sc.nextLine();
                    System.out.println("ARE DRONES AVAILABLE?(YES/NO)");
                    String drones= sc.nextLine();
                    if(drones.equalsIgnoreCase("YES")){
                        allocateResources();

                    }
                    else if(drones.equalsIgnoreCase("No")){
                        System.out.println("You're continuing without allocating resources bcoz drones aren't available");
                        recon= true;
                    }
                    sc.nextLine();
                    System.out.println("Do you want to perform other Ricon Mission Operations?");
                ...
                case 3:
                    ...
                    sc.nextLine();
                    System.out.println("Do you want to perform otherRicon Mission Operations?");
                    ch= sc.nextLine();
                    if(ch.equalsIgnoreCase("YES")){
                        recon=true;
                    }
    ...
    public void assignTask(Personnel personnel) {
        ...
        System.out.println(":::::::::::::::::::::::::::::::::::::::::::");
        System.out.println("TASK 1----> SURVEILLANCE");
        System.out.println("TASK 2-----> INTELLIGENCE GATHERING");
        System.out.println("Select the Task Number");
        int task = sc.nextInt();
        if(task==1){
            System.out.println("Task is available");
            personnel.setPersonnelTask("SURVEILLANCE");
        }
        else if (task==2){
            personnel.setPersonnelTask("INTELLIGENCE GATHERING");
        }
        else{
    ...
    public void allocateResources() {
        ...
        System.out.println("-_______-________-________-______-_____-________-");
    ...
    public void trackMissionProgress() {
        ...
        System.out.println("Status 2: PENDING");
        System.out.println("Status 3: CLOSED-Or-DONE");
    ...
    public void generateMissionReport() {
        ...
        while(det){
            ...
            if(choice4 ==1){
                ...
                System.out.println("MISSION START DATE"+getStartDate());
                System.out.println("MISSION END DATE"+getEndDate());
                System.out.println("......................................................");
                sc.nextLine();
                System.out.println("Do you want to display other details?");
                String ch= sc.nextLine();
